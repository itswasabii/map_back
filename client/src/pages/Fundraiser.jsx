...
function Fundraiser() {
  ...
  return (
    <>
      <TopNav />
      <Sidebar />
      <Box className="relative scrollbar-f w-full h-[calc(100vh-70px)] lg:w-[calc(100vw-250px)] ml-[0px] lg:ml-[250px] overflow-y-scroll mt-[70px]">
        <Box
          h={"30vh"}
          bgPosition={"bottom"}
          bgRepeat={"no-repeat"}
            ...
            >
              ...
              <Box maxW={"650px"}>
                <Text letterSpacing={1}>
                  ...
                  <br />
                  Supporting students by providing mentorship, career support,
                  and increasing the number of scholarships available. Every
                  dollar raised will go towards creating a supportive
                ...
                <Text letterSpacing={1}>
                  ...
                  <br />
                  By supporting this project, you'll be investing in the future
                  of tech in Kenya. Your contribution will empower students to
                  pursue their dreams, gain valuable skills, and make a positive
              ...
              <Table variant="striped" color={'#111'}>
                ...
                <Thead bg="#101f3c">
                  <Tr>
                    ...
                    <Th color="#fff">Goal Amount</Th>
                    <Th color="#fff" isNumeric>
                      Current Amount
                    </Th>
                    <Th color="#fff">View</Th>
                  </Tr>
                </Thead>
                <Tbody>
                  {loading ? (
                    ...
                    fundraisers.map((fundraiser) => (
                      <Tr key={fundraiser.id}>
                        ...
                        <Td>{fundraiser.goal_amount}</Td>
                        <Td color={'#111'} isNumeric>{fundraiser.current_amount}</Td>
                        <Td>
                          <Link
                            to={`/forum/fundraising-donations/${fundraiser.id}`}
            ...
            <Accordion allowMultiple>
              ...
              <AccordionItem>
                ...
                <AccordionPanel pb={4}>
                  ...
                  You can volunteer your time to mentor students, spread the
                  word about Moringa School's mission, or participate in
                  fundraising events. Contact us to learn more about volunteer
                  opportunities and other ways to support our cause.
                </AccordionPanel>
              </AccordionItem>
              <AccordionItem>
                <h2>
                ...
                <AccordionPanel pb={4}>
                  At this time, donations are used to support various
                  initiatives at Moringa School, including student scholarships,
                  mentorship programs, and facility upgrades. However, if you
                  have specific preferences, please reach out to us, and we'll
